...
static void start_feed(GstElement *source, guint size, CustomData *data) {
    if (data->sourceid == 0) {
        ...
        data->sourceid = g_idle_add(reinterpret_cast<GSourceFunc>(push_data), data);
    }
}
...
int main(int argc, char *argv[]) {
    ...
    g_signal_connect(G_OBJECT (bus), "message::error", reinterpret_cast<GCallback>(error_cb), &data);
